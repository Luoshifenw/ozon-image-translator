                ...
                <div className="text-center mb-8">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-blue-50 mb-4 text-blue-600">
                        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11.5 14.793l-.293.293D3.12 3.12 0 012 11.571V14a1 1 0 001 1h1v1a1 1 0 001 1h1v1a1 1 0 001 1h1v1a1 1 0 001 1h2a1 1 0 001-1v-1.586z" />
                        </svg>
                    </div>
